  ...
  <div class="my-5 px-4">
    ...
    <div class="h-line bg-dark"></div>
      <p class="text-center mt-3">
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id possimus expedita accusamus 
        <br>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4 border-top border-4 border-dark pop">
          ...
          <img src="images/features/wifi_Symbol.webp" width="40px">
          <h5 class="m-0 ms-3 ">Wifi</h5>
        </div>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem consequuntur
             minima sed voluptatem amet vel voluptatibus inventore laboriosam
          </p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-5 px-4">

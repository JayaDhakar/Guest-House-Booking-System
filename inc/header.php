 ...
 <li><a class="dropdown-item" href="#">Godawan</a></li>
 <li><hr class="dropdown-divider" /></li>
 <li>
 <a class="dropdown-item" href="index.php">Blue City Inn</a>
 </li>
 <li><hr class="dropdown-divider" /></li>
 <li><a class="dropdown-item" href="#">DLJ-Guest House</a></li>
 </ul>
 </li>
 <li class="nav-item">
 ...
 <a href="/hotel/admin/admin_index.php" ><button
 type="button"
 ...
 >Note: Your details must match with Id (Aadhar card, passport,

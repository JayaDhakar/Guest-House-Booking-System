  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="row">
          ...
          <nav class="navbar navbar-expand-lg bg-body-tertiary rounded shadow">
            <div class="container-fluid flex-lg-column align-items-stretch">
              ...
              >
                ...
                <div class="border bg-light p-3 rounded mb-3">
                  <h5 class="mb-3" style="font-size: 18px">Room Types</h5>
                  <div class="mb-2">
                    <input
                      type="checkbox"
                      id="f1"
        ...
        <div class="col-lg-9 col-md-12 px-4 border-0 shadow">
          <div class="card mb-4">
            <div class="row g-0 p-3 align-items-center">
              <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                <img src="/hotel/images/h-2.jpeg" class="img-fluid rounded" />
              </div>
              <div class="col-md-5 px-lg-3 px-md-3 px-0">
                <h5 class="mb-1">VIP Room</h5>
                ...
                <div class="mb-2">
                  <input
                    ...
                    class="form-check-input; shadow-none me-1"
                  />
                  <label class="form-check-label" for="f1">Single</label>
                </div>
                <div class="mb-2">
                  <input
                    type="checkbox"
                    ...
                    class="form-check-input; shadow-none me-1"
                  />
                  <label class="form-check-label" for="f2">Double</label>
                </div>
                <div class="mb-2">
                  <input
                    type="checkbox"
                    ...
                    class="form-check-input; shadow-none me-1"
                  />
                  <label class="form-check-label" for="f3">Triple</label>
                </div>
              </div>
          ...
          <div class="card mb-4">
            <div class="row g-0 p-3 align-items-center">
              <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                <img src="/hotel/images/h-3.jpeg" class="img-fluid rounded" />
              </div>
              <div class="col-md-5 px-lg-3">
                <h5 class="mb-1">Family Room</h5>
                <!-- <div class="guests"></div> -->
                <div class="mb-2">
                  <input
                    type="checkbox"
